...
**XGoTerm** 是一款基于 **Go** 和 **React** 开发的强大现代化 SSH 终端客户端，由 **Wails** 框架驱动。作为 Xshell 的免费开源替代品，它提供企业级特性，包括多标签会话管理、SFTP 文件管理、会话录制和跳板机支持。全程无任何外网接触，不用担心资产信息暴露，本地信息也被加密存储无法直接查看！
